...
class LongdpoleEnv2(gym.Env):
    ...
    def __init__(self, render=False):
        ...
        self.env.setLengthMass2(0.7,0.07)
        self.seed()
    ...
    def render(self, mode='human'):
        ...
        l,r,t,b = -polewidth*self.length,polewidth*self.length,polelen-polewidth*self.length,-polewidth*self.length
